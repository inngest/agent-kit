...
export function Sidebar({ 
  ...
  return (
    <div className={cn(
      'flex flex-col h-full bg-[#F9F9F9] dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transition-all duration-300',
        ...
        {isMinimized ? (
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              <div className="text-xs">Open sidebar</div>
            </TooltipContent>
          </Tooltip>
        ) : (
          ...
          <>
            ...
            {/* Toggle button only visible when maximized */}
            <Button
              variant="ghost"
              size="sm"
              onClick={onToggle}
      ...
      <div className="flex flex-col gap-1 px-2 pb-2">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 19 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="opacity-65" aria-hidden="false" aria-label="New chat">
        ...
        >
          <SearchIcon className="h-5 w-5 opacity-65" />
          {!isMinimized && (
            <div className="flex items-center justify-between w-full">
