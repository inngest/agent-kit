---
title: "Code Assistant v3: Autonomous Bug Solver"
sidebarTitle: "3. Autonomous Bug Solver"
description: "Build a custom Agent Router for semi-autonomy and advanced tools to solve bugs."
---
...
Our AI Agent will operate over an express API project filled of bugs:
...
the creation of a custom [Router Agent](/concepts/routers#routing-agent-autonomous-routing) brining to routing autonomy of the AI Agent.
...
Separating the Agents into two distinct roles will enable our AI Agent to better _"divide and conquer"_ the problem to solve.
