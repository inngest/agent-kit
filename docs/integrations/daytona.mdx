---
title: Using AgentKit with Daytona
description: "Build Coding Agents with Daytona's secure and elastic infrastructure for executing AI-generated code"
sidebarTitle: "Daytona - AI sandboxes"
---
...
<Steps>
  <Step title="Install AgentKit and Daytona">
  ...
  <Step title="Setup the Coding Agent">
...
const codingAgent = createAgent({
  ...
  <Step title="Create the Daytona Tools">
...
const codingAgent = createAgent({
  ...
  <Step title="Create agent network">
