...
As covered in the [deployment guide](/concepts/deployment), moving an AgentKit network into users' hands requires configuring usage limits.
...
Your AgentKit network will now be able to run 10 requests per user.
