...
- Invoked at the end of a successful agent or network run
- Receives only the _new_ results generated during this run (AgentKit automatically filters out historical results to prevent duplicates)
...
<AccordionGroup>
  ...
  <Accordion title="Implement Idempotency with Message IDs and Checksums">
  ...
  <Accordion title="Return Complete Conversation History">
  ...
  <Accordion title="Implement Upsert in createThread">
