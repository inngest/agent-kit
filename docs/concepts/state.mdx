...
- `toolCalls`: The results of any [Tools](/concepts/tools) called by the Agent as an array of `ToolResultMessage` objects.
- `raw`: Raw API response

{/* TODO - Link to reference with all types, methods, etc. */}
...
{/* TODO - Link to references, add more "why" or use cases */}
